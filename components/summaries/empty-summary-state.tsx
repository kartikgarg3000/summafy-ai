...
export default function EmptySummaryState() {
    return <div className="text-center py-12">
        <div className="flex flex-col items-center gap-4">
            ...
            <Link href={'/upload'}>
                <Button variant={'link'} className=" hover:no-underline mt-4 text-white bg-linear-to-r from-teal-500 to-teal-700 hover:from-teal-600 hover:to-teal-800"> Create Your First Summary.
                </Button>
            </Link>
        </div>
    </div>

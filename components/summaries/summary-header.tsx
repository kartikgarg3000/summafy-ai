    ...
    return (
        <div className="flex gap-4 mb-4 justify-between">
            <div className="space-y-6">
                <div className="flex flex-wrap items-center gap-4">
                    <Badge variant="secondary"
                        ...
                        <Sparkles className="g-4 w-4 mr-1.5 text-teal-500" />
                        AI Summary
                    </Badge>
            ...
            <div className="self-start">
                <Link href={'/dashboard'}>
                    <Button variant={'link'} size={'sm'} className="group flex items-center gap-1 sm:gap-2 hover:bg-white/80  backdrop-blur-xs rounded-full transition-all duration-200 shadow-xs hover:shadow-md border border-teal-100/30 bg-teal-100 px-2 sm:px-3 hover:no-underline"
                    >
                        <ChevronLeft className="h-3 w-3 sm:h-4 sm:w-4 text-teal-500 transition-transform group-hover:translate-x-0.5" />
